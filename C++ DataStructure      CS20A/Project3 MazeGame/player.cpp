...
void Player::update() {
    ...
    if (lookAhead == getAquarium()->getEndPoint())
		{
            return;
     
	    }

        //The following functions check each directions 
	 
        Point west(lookAhead.getX() - 1, lookAhead.getY());
        ...
        Point east(lookAhead.getX() + 1, lookAhead.getY());
        ...
        Point north(lookAhead.getX(), lookAhead.getY() - 1);
        ...
        Point south(lookAhead.getX(), lookAhead.getY() + 1);
